...
application = tornado.web.Application( [
    ...
    ( "^/(?P<access>[_0-9a-zA-Z]+)/wiki-edit$",                 controllers.wiki_edit         ),
    ( "^/(?P<access>[_0-9a-zA-Z]+)/web$",                       controllers.web               ),
    ( "^/(?P<access>[_0-9a-zA-Z]+)/web-share$",                 controllers.web_share         ),
    ...
    ( "^/redirect/(?P<redirect>[_0-9a-zA-Z]+)$",                controllers.redirect          ),
